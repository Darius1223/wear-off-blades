...
class Ui_WearOfBlades(object):
    def setupUi(self, WearOfBlades):
        ...
        self.gridLayout.addWidget(self.third_lineEdit3, 21, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.second_lineEdit3, 13, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.third_lineEdit4, 22, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.first_lineEdit3, 5, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.second_pushButton, 13, 0, 1, 1)
        ...
        self.gridLayout.addWidget(self.first_pushButton, 5, 0, 1, 1)
    ...
    def retranslateUi(self, WearOfBlades):
        ...
        self.fifth_lineEdit1.setPlaceholderText(_translate("WearOfBlades", "Значение, м"))
        self.label_2.setText(_translate("WearOfBlades", "WearOfBlades"))
        self.fourth_lineEdit1.setPlaceholderText(_translate("WearOfBlades", "Значение, м"))
        ...
        self.fourth_lineEdit3.setPlaceholderText(_translate("WearOfBlades", "Ресурс ножа, ч"))
        self.first_lineEdit1.setPlaceholderText(_translate("WearOfBlades", "Значение, мм"))
        self.third_lineEdit2.setPlaceholderText(_translate("WearOfBlades", "Значение, мин"))
        self.fifth_name1.setText(_translate("WearOfBlades", "Предельная наработка ножа, м"))
        self.second_lineEdit1.setPlaceholderText(_translate("WearOfBlades", "Значение, мм"))
        self.third_lineEdit3.setPlaceholderText(_translate("WearOfBlades", "Значение, мм"))
        self.fourth_name1.setText(_translate("WearOfBlades", "Предельная наработка ножа, м"))
        self.second_lineEdit2.setPlaceholderText(_translate("WearOfBlades", "Значение, мм"))
        self.third_title.setText(_translate("WearOfBlades", " 3. Предельная наработка дискового ножа, м"))
        self.fifth_lineEdit4.setPlaceholderText(_translate("WearOfBlades", "Коэф. ускоренных испытаний"))
        self.first_title.setText(_translate("WearOfBlades", " 1. Величина износа дискового ножа, мм"))
        self.second_lineEdit3.setPlaceholderText(_translate("WearOfBlades", "Относительное затупление, %"))
        self.fourth_pushButton.setText(_translate("WearOfBlades", "Рассчитать"))
        self.third_lineEdit4.setPlaceholderText(_translate("WearOfBlades", "Значение, мм"))
        self.first_name2.setText(_translate("WearOfBlades", " <b>После испытаний, мм</b>"))
        self.third_lineEdit1.setPlaceholderText(_translate("WearOfBlades", "Значение, об/мин"))
        self.fifth_lineEdit2.setPlaceholderText(_translate("WearOfBlades", "Значение, мин"))
        self.third_lineEdit5.setPlaceholderText(_translate("WearOfBlades", "Предельная наработка, м"))
        ...
        self.first_lineEdit2.setPlaceholderText(_translate("WearOfBlades", "Значение, мм"))
        self.fourth_lineEdit2.setPlaceholderText(_translate("WearOfBlades", "Значение, мин"))
        ...
        self.first_lineEdit3.setPlaceholderText(_translate("WearOfBlades", "Величина износа, мм"))
        ...
        self.fifth_lineEdit3.setPlaceholderText(_translate("WearOfBlades", "Значение, м/мин"))
